...
namespace object
{
  ...
  void Renamer::operator()(ast::TypeDec& e)
  {
    ...
    if (e.class_names_get().find(&e) == e.class_names_get().end())
      {
        e.name_set(e.name_get().fresh(e.name_get()));
        e.class_name_get[&e] = e.name_get();
      }
    super_type::operator()(e);
  ...
  void Renamer::operator()(ast::MethodCallExp& e)
  {
    ...
    if (e.class_names_get().find(e.def_get()) == e.class_names_get().end())
      {
        super_type::operator()(e.def_get());
      }

    e.name_set(e.class_names_get()[e.def_get()]);
    super_type::operator()(e);
  }
